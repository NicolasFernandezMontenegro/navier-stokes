...
#include <cstdlib>      // en vez de <stdlib.h>
#include <cstdio>       // en vez de <stdio.h>
#include <cmath>        // en vez de <math.h>
#include <GL/glut.h>    // sigue igual, es una lib C pero compatible
